...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(PCF8553_CE_GPIO_Port, PCF8553_CE_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED_ERROR_Pin|LED_ACTIVE_Pin|LED_SIGNAL_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin : PCF8553_CE_Pin */
  GPIO_InitStruct.Pin = PCF8553_CE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(PCF8553_CE_GPIO_Port, &GPIO_InitStruct);
